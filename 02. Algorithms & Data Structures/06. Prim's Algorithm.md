...
- The algorithm continuously increases the size of a tree, one edge at a time, starting with a tree consisting of a single vertex, until it spans all vertices.
	...
	- <mark style="background: #BD6500;">Initialise:</mark> Vnew = {x}, where x is an arbitrary node (starting point) from V, Enew = {}
	- <mark style="background: #BD6500;">Repeat</mark> until Vnew = V:
	...
	- <mark style="background: #BD6500;">Output:</mark> Vnew and Enew describe a minimal spanning tree
